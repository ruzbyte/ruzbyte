...
Started with Java and Object Orientation, followed by C# RPG4 (Free, unfree) and relational databases during vocational training. <br/>
Currently I'm employed as a working student while studying Computer Engineering. <br/>
In my free time I develop web applications and mobile apps with Flutter, NextJS and occasionally .NET

## Tech Stack

### Frontend

[![Frontend](https://skillicons.dev/icons?i=dotnet,nextjs,svelte,tailwind,flutter,react)](https://skillicons.dev)

### Backend

[![Backend](https://skillicons.dev/icons?i=cs,py,ts,dart,firebase,postgres,java,mysql)](https://skillicons.dev)
